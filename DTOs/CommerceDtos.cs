...
public record CartItemDto(Guid Id, Guid CourseId, string CourseTitle, Guid? CourseRoundId, decimal UnitPriceEgp, decimal DiscountAmountEgp, decimal FinalPriceEgp, bool IsBundleItem);
